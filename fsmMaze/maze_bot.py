...
class MazeBot:
    ...
    def add_state_transitions(self):
        ...
        self.fsm.add_transition('B', "BN", self.move_north, "MN")
        self.fsm.add_transition('B', "BW", self.move_west, "NW")


        self.fsm.add_transition('X', "NS", self.move_south, None)
        self.fsm.add_transition('X', "NE", self.move_east, None)
        self.fsm.add_transition('X', "NN", self.move_north, None)
        self.fsm.add_transition('X', "NW", self.move_west, None)
        ...
        self.fsm.add_transition('#', "NS", self.move_east, "NE")
        self.fsm.add_transition('#', "NE", self.move_north, "NN")
        self.fsm.add_transition('#', "NN", self.move_west, "NW")
        self.fsm.add_transition('#', "NW", self.move_south, "NS")

        self.fsm.add_transition('#', "BS", self.move_east, "BE")
        self.fsm.add_transition('#', "BE", self.move_north, "BN")
        self.fsm.add_transition('#', "BN", self.move_west, "BW")
        self.fsm.add_transition('#', "BW", self.move_south, "BS")
